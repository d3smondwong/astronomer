...
seasonal_info = {
    "寅": {"season": "初春", "旺": "木", "相": "火", "休": "水", "囚": "金", "死": "土", "climate": "余寒", "needs": "火"},
        "卯": {"season": "仲春", "旺": "木", "相": "火", "休": "水", "囚": "金", "死": "土", "climate": "温", "needs": "平衡"},
        "辰": {"season": "季春", "旺": "土", "相": "金", "休": "火", "囚": "木", "死": "水", "climate": "湿", "needs": "木, 金"},
        "巳": {"season": "初夏", "旺": "火", "相": "土", "休": "木", "囚": "水", "死": "金", "climate": "炎", "needs": "水"},
        "午": {"season": "仲夏", "旺": "火", "相": "土", "休": "木", "囚": "水", "死": "金", "climate": "燥", "needs": "水"},
        "未": {"season": "季夏", "旺": "土", "相": "金", "休": "火", "囚": "木", "死": "水", "climate": "暑", "needs": "水"},
        "申": {"season": "初秋", "旺": "金", "相": "水", "休": "土", "囚": "火", "死": "木", "climate": "凉", "needs": "平衡"},
        "酉": {"season": "仲秋", "旺": "金", "相": "水", "休": "土", "囚": "火", "死": "木", "climate": "清", "needs": "平衡"},
        "戌": {"season": "季秋", "旺": "土", "相": "金", "休": "火", "囚": "木", "死": "水", "climate": "燥", "needs": "水"},
        "亥": {"season": "孟冬", "旺": "水", "相": "木", "休": "金", "囚": "土", "死": "火", "climate": "寒", "needs": "火"},
        "子": {"season": "仲冬", "旺": "水", "相": "木", "休": "金", "囚": "土", "死": "火", "climate": "严寒", "needs": "火"},
        "丑": {"season": "季冬", "旺": "土", "相": "金", "休": "火", "囚": "木", "死": "水", "climate": "湿冷", "needs": "火"},
    }
...
def get_basic_info(
    standard_solar_birthday: datetime, latitude: float, longitude: float
) -> dict:
    """
    ...
    season_context = {
        ...
        "调候分析": {
            ...
            "调节紧迫性": "高" if seasonal_info.get("climate") in ["严寒", "寒", "湿冷", "炎", "燥", "暑"] else "中"
        },
        "节气窗口": {
...
if __name__ == "__main__":
    ...
    result = get_basic_info(standard_solar, latitude, longitude)
