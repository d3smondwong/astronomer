  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        vhidden: "hidden",
        dropdown_month: "inline-flex items-center justify-center rounded-md text-sm font-medium h-8 px-3 border bg-background",
        dropdown_year: "inline-flex items-center justify-center rounded-md text-sm font-medium h-8 px-3 border bg-background",
