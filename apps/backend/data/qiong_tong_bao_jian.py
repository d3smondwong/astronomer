'''
《穷通宝鉴》 (Qiong Tong Bao Jian / The Treasury of Prosperity and Insight)

Qiong Tong Bao Jian is a foundational text for Tiao Hou (climatic adjustment). It tells you which elements are favorable or unfavorable based on the month.

This classical text emphasizes the seasonal nature of the Day Master. It provides insights into the combinations of the Day Master and the Month Branch, guiding practitioners on how to adjust their lives according to the changing seasons. The text is structured around the 12 months, each associated with specific characteristics and recommendations for the Day Master.

This module looks at the combination: Day Master + Month Branch
'''
...
def get(key: str) -> str | None:
    """Lookup seasonal adjustment (Tiao Hou) by DayStem + MonthBranch key."""
    return DATA.get(key)