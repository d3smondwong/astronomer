"""
《三命通会》 (Three Lives Comprehensive Record)

San Ming Tong Hui is the most comprehensive classical BaZi text. The hour pillar represents the later part of life, children, and one’s most inner actions.

This module looks at the combination: Day Master + Hour Pillar (Hour Stem + Hour Branch)
"""
...
def get(key: str) -> str | None:
    """Lookup San Ming Tong Hui commentary by DayStem + '日' + HourStem + HourBranch key."""
    return DATA.get(key)
